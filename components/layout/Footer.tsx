  ...
  return (
    <footer className="relative overflow-hidden bg-[#1f2228] px-4 py-10 sm:px-6 sm:py-12 lg:px-12">
      <Image
        ...
        width={560}
        height={560}
        className="pointer-events-none absolute -bottom-52 -left-52 h-140 w-140"
      />

      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 md:grid-cols-[1fr_260px] md:items-start">
          <div>
            <Link href="/" aria-label="H-Tube home" className="inline-flex">
              <Image src="/icons/logo.svg" alt="H-Tube" width={140} height={40} className="h-10 w-auto" />
            </Link>
